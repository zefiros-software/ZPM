...
if defined GH_TOKEN (
    powershell -command "Invoke-WebRequest -Uri https://github.com/Zefiros-Software/premake-core/releases/download/v5.0.0-zpm-alpha12.1/premake-windows.zip -OutFile premake5.zip -Headers @{'Authorization'='token %GH_TOKEN%'}"
) else (
    powershell -command "Invoke-WebRequest -Uri https://github.com/Zefiros-Software/premake-core/releases/download/v5.0.0-zpm-alpha12.1/premake-windows.zip -OutFile premake5.zip"
)
